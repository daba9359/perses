...
class DarkMatterAnnihilationModel(LoadableModel):
    ...
    def __call__(self, parameters):
        ...
        parameters: array of length 2, with the first value being the efficiency of dark matter annihilation (f_dman),
                    ...
                    Theory allows for an upper limit of 2e-22 
    ...
    def load_from_hdf5_group(group):
        ...
        return DarkMatterAnnihilationModel(frequencies, in_Kelvin=in_Kelvin)
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, DarkMatterAnnihilationModel):
            return False
